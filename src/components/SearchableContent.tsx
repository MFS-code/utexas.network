...
export default function SearchableContent({ members, projects, connections }: SearchableContentProps) {
    ...
    useEffect(() => {
        const joinType = new URLSearchParams(window.location.search).get('join');
        if (joinType !== 'member' && joinType !== 'project') {
            return;
        }

        setFormType(joinType);
        ...
        try {
            ...
            setSubmitStatus({
                ...
                message: typeof result.message === 'string'
                    ? result.message
                    : 'Request sent. You will receive updates after a manual review.',
            });
                ...
                >
                    ...
                    >
                        ...
                        <form className="join-form" onSubmit={handleJoinSubmit} ref={joinFormRef}>
                            ...
                            <p className="join-tip">
                                share only information you are comfortable sending to the maintainers for manual review.
                            </p>
